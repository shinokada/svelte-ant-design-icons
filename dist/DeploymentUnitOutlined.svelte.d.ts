 ...
 * @props:desc: DescType;
 */
export default class DeploymentUnitOutlined extends SvelteComponent<DeploymentUnitOutlinedProps, DeploymentUnitOutlinedEvents, DeploymentUnitOutlinedSlots> {
}
export {};
