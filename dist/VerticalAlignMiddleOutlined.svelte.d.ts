 ...
 * @props:class?: string;
 */
export default class VerticalAlignMiddleOutlined extends SvelteComponent<VerticalAlignMiddleOutlinedProps, VerticalAlignMiddleOutlinedEvents, VerticalAlignMiddleOutlinedSlots> {
}
export {};
