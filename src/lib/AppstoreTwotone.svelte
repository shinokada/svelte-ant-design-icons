<script>export let size="24"; export let strokeColor="#333";export let insideColor="#E6E6E6"; export let ariaLabel="appstore" </script>
...
<svg xmlns="http://www.w3.org/2000/svg" {...$$restProps} width={size} height={size} 
 class={$$props.class} aria-label={ariaLabel} on:click on:mouseenter on:mouseleave on:mouseover on:mouseout on:blur on:focus viewBox="0 0 1024 1024">
  ...
  <path fill={insideColor} d="M212 212h200v200H212zm400 0h200v200H612zM212 612h200v200H212zm400 0h200v200H612z"/>
</svg>
