<script>export let size="24"; export let strokeColor="currentColor";export let insideColor="#D9D9D9"; export let ariaLabel="audio" </script>
...
<svg xmlns="http://www.w3.org/2000/svg" {...$$restProps} width={size} height={size} fill={strokeColor} class={$$props.class} aria-label={ariaLabel} on:click on:mouseenter on:mouseleave on:mouseover on:mouseout on:blur on:focus viewBox="0 0 1024 1024">
  <path fill={insideColor} d="M512 552c54.3 0 98-43.2 98-96V232c0-52.8-43.7-96-98-96s-98 43.2-98 96v224c0 52.8 43.7 96 98 96z"/>
