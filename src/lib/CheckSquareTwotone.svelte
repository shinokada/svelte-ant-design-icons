<script lang='ts'>
  ...
  let { 
    ...
    desc, 
    class: classname, 
    ariaLabel =  "check square twotone" , 
    onclick, 
    onkeydown, 
    onkeyup,
    ...restProps 
...
@prop ariaLabel =  "check square twotone"
@prop onclick
@prop onkeydown
@prop onkeyup
@prop ...restProps
