<script>
  ...
  export let ariaLabel = 'eye invisible';
</script>
...
>
  <defs
    ><clipPath><path fill="none" d="M124-288l388-672 388 672H124z" clip-rule="evenodd" /></clipPath
    ></defs
  ><path
...
@prop export let ariaLabel = 'eye invisible';
-->
