<script>
  ...
  export let ariaLabel = 'field string';
</script>
...
<svg
  ...
  ><defs><style type="text/css"></style></defs><path
    ...
    p-id="12119"
  ></path><path d="M877 729m-36 0a36 36 0 1 0 72 0 36 36 0 1 0-72 0Z" p-id="12120"></path><path
...
@prop export let ariaLabel = 'field string';
-->
