<script>
  ...
  export let ariaLabel = 'folder view';
</script>
...
<svg
  ...
  ><defs><style type="text/css"></style></defs><path
    ...
    p-id="13661"
  ></path><path d="M513 573m-56 0a56 56 0 1 0 112 0 56 56 0 1 0-112 0Z" p-id="13662"></path><path
...
@prop export let ariaLabel = 'folder view';
-->
