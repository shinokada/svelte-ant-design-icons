<script>export let size="24"; export let strokeColor="currentColor";export let insideColor="#D9D9D9"; export let ariaLabel="reconciliation" </script>
