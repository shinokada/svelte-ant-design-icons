<script>export let size="24"; export let strokeColor="currentColor";export let insideColor="#D9D9D9"; export let ariaLabel="rest" </script>
...
<svg xmlns="http://www.w3.org/2000/svg" {...$$restProps} width={size} height={size} fill={strokeColor} class={$$props.class} aria-label={ariaLabel} on:click on:mouseenter on:mouseleave on:mouseover on:mouseout on:blur on:focus viewBox="0 0 1024 1024">
  <path fill={insideColor} d="M326.4 844h363.2l44.3-520H282l44.4 520zM508 416c79.5 0 144 64.5 144 144s-64.5 144-144 144-144-64.5-144-144 64.5-144 144-144z"/>
