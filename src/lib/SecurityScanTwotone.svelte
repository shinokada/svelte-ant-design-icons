<script>
  ...
  export let ariaLabel = 'security scan';
</script>
...
>
  ...
  />
  <path fill={insideColor} d="M460.7 451.1a80.1 80.1 0 1 0 160.2 0 80.1 80.1 0 1 0-160.2 0z" />
  <path
    fill={insideColor}
...
@prop export let ariaLabel = 'security scan';
-->
