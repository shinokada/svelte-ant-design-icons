<script lang='ts'>
  ...
  let { 
    ...
    desc, 
    class: classname, 
    ariaLabel =  "video camera add outlined" , 
    ...restProps 
  }: Props = $props();
...
@prop ariaLabel =  "video camera add outlined"
@prop ...restProps
-->
