<script lang="ts">
  ...
  import { AccountBookFilled } from '$lib';
...
<h1>Getting Started - Svelte Ant Design Icons v1</h1>
...
<div class="my-8 flex gap-2">
  <a href="https://github.com/sponsors/shinokada" target="_blank"
    ...
    /></a
  >
  <a href="https://www.npmjs.com/package/svelte-ant-design-icons" rel="nofollow" target="_blank"
    ><img src="https://img.shields.io/npm/v/svelte-ant-design-icons" alt="npm" /></a
  >
...
<p>Install Svelte and Svelte Ant Design Icons:</p>
...
<p>Use <Code>import * as Icon from 'svelte-ant-design-icons</Code>.</p>
