...
<h1>Svelte And Design Icons v1: Props</h1>
...
<p>Add a custom size using Tailwind CSS by including the desired classes in the <Code>class</Code> prop. For example:</p>
